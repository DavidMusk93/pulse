...
PULSE_EXPIRED_HOST_RETENTION_MS=300000
PULSE_TASK_DIR=${install_root}/tasks
PULSE_METRICS_DB=${install_root}/data/pulse-metrics.db
PULSE_LOCAL_STORAGE_ENABLED=true
PULSE_LOCAL_STORAGE_MODE=segmented
PULSE_LOCAL_STORAGE_PATH=${install_root}/data/pulse-metrics.db
PULSE_LOCAL_STORAGE_SHARD_DIR=${install_root}/data/metrics-v2
...
PULSE_LOCAL_STORAGE_MAINTENANCE_INTERVAL_MS=300000
PULSE_LOCAL_STORAGE_CLEANUP_LIMIT=10000
ENV
